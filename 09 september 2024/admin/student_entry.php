                ...
                <div class="row mg-t-80">
                    <div class="col-xl-12">
                        <div class="form-layout form-layout-4">
                            ...
                            <div class="row mg-t-20">
                                <label class="col-sm-4 form-control-label">GENDER: <span
                                        class="tx-danger">*</span></label>
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    Male <input type="radio" class="form-control-m" name="gender" value="Male">
                                    Female <input type="radio" class="form-control-m" name="gender" value="Female">
                                </div>
                            </div>
                            <div class="row mg-t-20">
                            ...
                            <div class="row mg-t-20">
                                <label class="col-sm-4 form-control-label">PHONE: <span
                                        class="tx-danger">*</span></label>
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
