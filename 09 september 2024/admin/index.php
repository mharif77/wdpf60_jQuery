...
<body>
  ...
  <div class="d-flex align-items-center justify-content-center ht-100v">
    ...
    <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
        <div class="signin-logo tx-center tx-28 tx-bold tx-white"><span class="tx-normal">[</span> log <span
            class="tx-info">in</span> <span class="tx-normal">]</span></div>
  ...
  session_destroy();
        ...
        <form action="login.php" method="post">
          ...
          <div class="form-group">
            <input type="password" class="form-control fc-outline-dark" name="password"
