			...
			<div class="auto-container">
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-12 col-12  mb-lg-0 mb-md-4 mb-sm-5 mb-5 footer-widget">
						...
						<!-- end widget title -->
						<div class="about">
							<p>Sensiv Hospitals is one of the most multi-specialty healthcare provider catering to both
								native & foreigner patients.</p>
							<p>Manage your health the easier way with the Sensiv Hospital mobile app. Download it today!
								Available on.</p>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12 col-12  mb-lg-0 mb-md-0 mb-sm-5 mb-5 footer-widget">
						...
						<div class="flick-post">
							<div class="single-flick-post">
								...
								<a href="assets/img/gallery/4.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
							<div class="single-flick-post">
								<a href="#"><img class="img-fluid" src="assets/img/gallery/3.jpg" alt=""></a>
								<a href="assets/img/gallery/3.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
							<div class="single-flick-post">
								<a href="#"><img class="img-fluid" src="assets/img/gallery/5.jpg" alt=""></a>
								<a href="assets/img/gallery/5.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
							<div class="single-flick-post">
								<a href="#"><img class="img-fluid" src="assets/img/gallery/1.jpg" alt=""></a>
								<a href="assets/img/gallery/1.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
							<div class="single-flick-post">
								<a href="#"><img class="img-fluid" src="assets/img/gallery/2.jpg" alt=""></a>
								<a href="assets/img/gallery/2.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
							<div class="single-flick-post">
								<a href="#"><img class="img-fluid" src="assets/img/gallery/10.jpg" alt=""></a>
								<a href="assets/img/gallery/10.jpg" class="venobox info icon vbox-item"
									data-title="FLICKR TITTLE" data-gall="gall1"><i
										class="icofont icofont-link"></i></a>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-12 footer-widget">
						...
						<ul class="quick-link-list">
							...
							<li><a href="#"><i class="icofont icofont-clock-time"></i> Open: Mon to Sat: 9AM to 5PM</a>
							</li>
						</ul>
