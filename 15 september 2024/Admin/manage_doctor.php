                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">manage_doctor</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">mange_doctor</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="sub-title">DataTables has most features enabled by default, so all you
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <td><a href=""><a href=""><div class="button-items"><input class="btn btn-warning" type="submit" value="Edit">
                                                <input class="btn btn-danger" type="reset" value="delete"></div></a></a></td>
