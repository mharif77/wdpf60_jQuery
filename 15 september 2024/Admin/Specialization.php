                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">specilization</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href=""><a href="">
                                                                <div class="button-items" data-toggle="modal"
                                                                    data-target=".specilization-edit-modal"><input
                                                                        class="btn btn-warning" type="submit" value="Edit">
                    ...
                    <!-- end row -->
                    <div class="modal fade specilization-edit-modal" tabindex="-1" role="dialog"
